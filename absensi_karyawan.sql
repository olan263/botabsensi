...
CREATE TABLE IF NOT EXISTS absensi (
    ...
    foto              VARCHAR(255),                 -- path/nama file foto bukti absen
...
-- ==========================================================
-- SCRIPT SQL: Tambah kolom jabatan_pic ke tabel kegiatan
-- Jalankan ini SEKALI di database absensi_karyawan kamu (pgAdmin 4)
-- ==========================================================

ALTER TABLE kegiatan
ADD COLUMN IF NOT EXISTS jabatan_pic VARCHAR(100);
